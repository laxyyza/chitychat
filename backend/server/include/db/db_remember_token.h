...
bool db_async_select_remember_token(server_db_t* db, const u8* token_hash, dbcmd_ctx_t* ctx);
bool db_async_update_remember_token(server_db_t* db, remember_token_t* rt, dbcmd_ctx_t* ctx);
