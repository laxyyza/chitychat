...
bool db_async_user_in_group(server_db_t* db, u32 group_id, u32 user_id, dbcmd_ctx_t* ctx);
...
bool db_async_delete_msg(server_db_t* db, u32 msg_id, u32 user_id, dbcmd_ctx_t* ctx);
